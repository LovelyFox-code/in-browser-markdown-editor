...
import { Document, Form, Icon, Input, InputSideBar, Label } from "../Style/Styled";

export default function Documents(props) {


  const files = props.files;
  const fileNames = files.map(el => <Document>
    ...
    <Form>
      <Label>{el.createdAt}</Label>
      <InputSideBar placeholder={el.name} />
    </Form>
  </Document>
  )
  return (
